...
class XUpload extends CJuiInputWidget {
    ...
    public function run() {
		...
		// start: MY CODE
		/*Yii::app()->clientScript->registerScript('myXUploadAdd', "jQuery('#{$this->htmlOptions['id']}').bind('fileuploadcompleted', function (e, data) {alert('fileuploadcompleted!'); console.log(e);});", CClientScript::POS_READY);
		Yii::app()->clientScript->registerScript('myXUploadDestroy', "jQuery('#{$this->htmlOptions['id']}').bind('fileuploaddestroyed', function (e, data) {alert('fileuploaddestroyed!');});", CClientScript::POS_READY);*/
        // end: MY CODE
